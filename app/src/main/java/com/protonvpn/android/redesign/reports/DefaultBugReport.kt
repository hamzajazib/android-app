...
private const val DEFAULT_BUG_REPORT_JSON = """
{
  "Categories": [
      {
        ...
        "InputFields": [
          {
            "Label": "Network type",
            "Type": "TextSingleLine",
            "Placeholder": "Home Wi-Fi, school Wi-Fi, work, public Wi-Fi",
...
val DefaultBugReport = Json {
    ignoreUnknownKeys = true
    encodeDefaults = true
}.decodeFromString<DynamicReportModel>(DEFAULT_BUG_REPORT_JSON)